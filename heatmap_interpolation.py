...
class HeatmapInterpolation(QWidget):
    ...
    def update_image(self, mat: np.ndarray):
        # === Interpolation: Increase resolution of mat ===
        upscale_factor = 2  # You can tweak this
        mat = zoom(mat, upscale_factor, order=2)  # cubic interpolation
        ...
        # === Trim trace history to last trace_duration seconds ===
        now = time.time()
